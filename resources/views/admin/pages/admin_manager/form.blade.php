    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <label for="fullname">Tên người dùng (<span class="text-red">*</span>)</label>
                <input
                name="fullname"
                type="text"
                ...
                value="{{$admin->fullname ?? old('fullname')}}"
                >
                @error('fullname')
            ...
            <div class="form-group">
                <label for="position">Username (<span class="text-red">*</span>)</label>
                <input
                name="username"
                type="text"
            ...
            <div class="form-group ">
                <div class="input-group">
                    <div class="custom-file">
                      <input name="avatar" type="file" class="custom-file-input" encyt>
                ...
                <img style="margin-top:30px" src="/storage/{{$admin->profile_photo_path}}" alt="" width="150px" height="150px">
                @error('avatar')
                <div id="" class="error invalid-feedback d-block">
                    {{$message}}
                </div>
