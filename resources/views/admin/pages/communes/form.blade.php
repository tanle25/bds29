    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                value="{{$commune->name_with_type ?? old('name_with_type')}}"
                >
            ...
            <div class="form-group">
                ...
                value="{{$commune->path_with_type ?? old('path_with_type')}}"
                >
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                value="{{$commune->details->area ?? old('area')}}"
                >
                @error('area')
                <div id="" class="error invalid-feedback d-block">
                        {{$message}}
            ...
            <div class="form-group">
                ...
                <textarea name="short_description"
                    ...
                    rows="3"
                    placeholder="Nhập mô tả ...">{{$commune->details->short_description ?? old('short_description')}}</textarea>
            ...
            <div class="form-group ">
                ...
                'current_input' => $commune->details->full_description ?? old('full_description') ?? ''
                ])
            ...
            <div class="form-group ">
                ...
                'input_name' => 'images',
                'current_input' => $commune->details->images ?? old('images')
                ])
            </div>
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <select class="form-control select2 select2-info" value="" name="type" data-dropdown-css-class="select2-info"
                    style="width: 100%;">
                    @foreach (config('constant.commune_type') as $key => $value)
                        <option @if(isset($commune) && $key == $commune->type) selected @endif value="{{$key}}">{{$value}}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 select2-info" value="" name="parent_code" data-dropdown-css-class="select2-info"
                    ...
                    @foreach ($districts as $district)
                        <option @if(isset($commune) && $district->code == $commune->parent_code) selected @endif value="{{$district->code}}">{{$district->name_with_type}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group ">
                ...
                'input_name' => 'avatar',
                'current_input' => $commune->details->avatar ?? old('avatar')
                ])
            </div>
        </div>
    </div>
