    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <label for="price">Nội thất(<span class="text-red">*</span>) <?php var_dump($realty->furniture); ?></label>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control ckeditor @error('description') is-invalid @enderror" rows="10"
