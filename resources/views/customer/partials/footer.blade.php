...
<div id="footer" class="footer">
	<div class="footer-top">
                    ...
                    {{-- <ul class="p-0 font-9"> --}}
                        @if ($loop->last)
                            @foreach ($item->childs as $child)
                                ...
                                <a class="d-flex align-items-center" rel="nofollow" class="" href="{{$child->href ?? ''}}" style="word-break: break-all">@if ($child->icon)
        ...
        @if (substr(url()->full(),0,51) == 'http://bds29.net/cho-thue-cau-giay-ha-noi?du-an=163')
...
<button class="position-fixed btn up-to-top-btn rounded-circle btn-info back-top">
