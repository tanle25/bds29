...
<div class="navigation sticky-top" id="navbar">
                ...
                <div class="header-right ml-auto d-none d-xl-flex align-items-center">
                    ...
                    <div class="login-logout d-flex align-items-center">
                        <div class="dropdown featured-top">
                            <button class="btn rounded-circle text-success px-2 py-1 list-featured-btn bg-white font-14" type="button" id="dropdownMenuButton1" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
    ...
    <section class="header-mobile px-3 pt-2 pb-2 d-md-none" style="background: #f9f9f9">
        <div class="d-flex justify-content-between align-items-center">
            <div class="nav-search-btn-scroll  w-100" style="display: none">
                <a href="#" class="nav-search-open text-dark d-md-none rounded p-2 d-block bg-white" data-toggle="modal" data-target="#nav-search">
            ...
            @if (Auth::check())
                ...
                @endphp
                <div class="dropdown featured-top">
                    <button class="btn px-2 py-1 list-featured-btn font-15 text-danger" style="background: transparent" type="button" id="dropdownMenuButton1" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
                        <i class="far fa-heart"></i>
                    </button>
            ...
            @else
                <button class="btn px-2 py-1 list-featured-btn-unauth font-15 text-danger" style="background: transparent" type="button" >
                    <i class="far fa-heart"></i>
                </button>
            @endif
        ...
        <div class="nav-search-btn">
            <a href="#" class="nav-search-open text-dark d-md-none rounded p-2  d-block bg-white w-100" data-toggle="modal" data-target="#nav-search">
                <i class="far fa-search font-10"></i> <span class="font-9" style="font-weight: 500">Tìm kiếm bất động sản</span>
            </a>
        </div>
</section>
