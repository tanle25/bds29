        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-6 col-sm-4 price-fav mb-3 mb-md-0">
                    ...
                    <input id="price" type="text" name="price" class="form-control" placeholder="Giá đề nghị"
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="hidden-feedback-icon">
            <textarea name="description" id="description" class="form-control text-description ckeditor" placeholder=""
