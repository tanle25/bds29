...
return [
    ...
    'confirmed' => ':attribute phải trùng vơi mật khẩu xác nhận.',
    ...
    'attributes' => [
        'realty_post_type' => 'Loại tin đăng',
        'realty_type' => 'Loại bất động sản',
        'area' => 'Diện tích',
        'direction' => 'Hướng',
        'number_of_floors' => 'Số tầng',
        'number_of_bed_rooms' => 'Số phòng ngủ',
        'number_of_bath_rooms' => 'Số phòng tắm',
        'price' => 'Giá',
        'province_code' => 'Tỉnh/Thành phố',
        'district_code' => 'Huyện',
        'commune_code' => 'Xã/Phường',
        'apartment_number' => 'Số nhà',
        'street' => 'Địa chỉ cụ thể',
        'register_email' => 'Email',
        'register_phone_number' => 'Số điện thoại đăng ký',
        'register_fullname' => 'Họ tên',
