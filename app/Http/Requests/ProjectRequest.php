...
class ProjectRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'site_area' => 'required|numeric|max:100000000',
            'construction_area' => 'numeric|max:100000000',
            'project_type' => 'numeric|max:10',
            'start_time' => '',

            'description' => 'max:100000',
            'location_description' => 'max:100000',
            'promotion_term' => 'max:100000',
        ];
    }
